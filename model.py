...
def quantizable_resnet50(num_classes, grayscale):
    """Constructs a ResNet-50 model."""
    model = ResNet(block=Bottleneck, layers=[3, 4, 6, 3], num_classes=num_classes, grayscale=grayscale, quantize=True)
    return model

def resnet50(num_classes, grayscale):
    """Constructs a ResNet-50 model."""
    model = ResNet(block=Bottleneck, layers=[3, 4, 6, 3], num_classes=num_classes, grayscale=grayscale, quantize=False)
    return model
